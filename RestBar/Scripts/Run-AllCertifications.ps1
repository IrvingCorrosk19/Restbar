...
$scripts = @(
    ...
    "ORDER_OPERATIONAL_CERTIFICATION\scripts\Run-EnterpriseAdditionalScenarios.ps1",
    "ORDER_OPERATIONAL_CERTIFICATION\scripts\Run-EnterpriseAdvancedScenarios.ps1"
)
