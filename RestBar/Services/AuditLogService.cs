...
namespace RestBar.Services
{
    public class AuditLogService : IAuditLogService
    {
        ...
        {
            // Ensure Timestamp is set to UTC for PostgreSQL timestamp with time zone
            if (auditLog.Timestamp == null)
            {
                auditLog.Timestamp = DateTime.UtcNow;
            }
            else if (auditLog.Timestamp.Value.Kind != DateTimeKind.Utc)
            {
                auditLog.Timestamp = DateTime.SpecifyKind(auditLog.Timestamp.Value, DateTimeKind.Utc);
            }
