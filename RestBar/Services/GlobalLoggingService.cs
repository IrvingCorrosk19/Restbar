...
namespace RestBar.Services
{
    public class GlobalLoggingService : IGlobalLoggingService
    {
        ...
        // ✅ NUEVO: Logging para módulo de proveedores
        public async Task LogSupplierActivityAsync(string action, string description, Guid supplierId, object? oldValues = null, object? newValues = null)
        {
            await _auditLogService.LogActivityAsync(
                action: action,
                module: AuditModule.SUPPLIER.ToString(),
                description: description,
                recordId: supplierId,
                tableName: "suppliers",
                oldValues: oldValues,
