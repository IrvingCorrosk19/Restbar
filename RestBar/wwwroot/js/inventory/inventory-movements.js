...
async function loadMovementsData() {
    try {
        console.log('[Frontend] Cargando datos de movimientos...');
        ...
        console.log('[Frontend] Datos de movimientos cargados:', movementsData.length, 'items');
        
        renderMovementsTable();
        updateMovementStats();
        
    } catch (error) {
        console.error('[Frontend] Error cargando movimientos:', error);
        Swal.fire({
            icon: 'error',
            title: 'Error',
...
async function saveMovement() {
    try {
        ...
        console.error('[Frontend] Error al guardar movimiento:', error);
        Swal.fire({
            icon: 'error',
            title: 'Error',
...
async function getInventoryId(productId, branchId) {
    try {
        ...
        console.error('[Frontend] Error al obtener inventario:', error);
        return null;
    }
}
...
function printMovement(movementId) {
    ...
    console.log('Imprimir movimiento:', movementId);
}
