...
async function loadModalData() {
    try {
        console.log('[Frontend] Cargando datos para modales...');
        ...
        console.log('[Frontend] Datos de modales cargados');
        
    } catch (error) {
        console.error('[Frontend] Error cargando datos de modales:', error);
    }
}
...
function filterInventoryData() {
    ...
    if (!Array.isArray(inventoryData)) {
        console.warn('[Frontend] inventoryData no es un array:', inventoryData);
        return [];
    }
...
async function saveCategory() {
    ...
    try {
        ...
        console.error('[Frontend] Error creando categoría:', error);
        Swal.fire({
            icon: 'error',
            title: 'Error',
...
async function saveBranch() {
    ...
    try {
        ...
        console.error('[Frontend] Error creando sucursal:', error);
        Swal.fire({
            icon: 'error',
            title: 'Error',
...
async function saveMovement() {
    ...
    try {
        ...
        console.error('[Frontend] Error registrando movimiento:', error);
        Swal.fire({
            icon: 'error',
...
async function viewMovementHistory(productId, branchId) {
    try {
        ...
        console.error('[Frontend] Error cargando historial de movimientos:', error);
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Error de conexión al cargar historial'
...
async function getMovementsByType(movementType) {
    try {
        ...
        console.error('[Frontend] Error obteniendo movimientos por tipo:', error);
        Swal.fire({
            icon: 'error',
            title: 'Error',
