...
function showDiscountModal() {
    console.log('[Frontend] showDiscountModal iniciado');
    console.log('[Frontend] currentOrder:', currentOrder);
    
    if (!currentOrder || !currentOrder.items || currentOrder.items.length === 0) {
        console.log('[Frontend] No hay orden o items para aplicar descuento');
        Swal.fire({
            icon: 'error',
            title: 'Error',
    ...
    console.log('[Frontend] Verificando elementos del modal...');
    const discountModalElement = document.getElementById('discountModal');
    console.log('[Frontend] discountModalElement:', discountModalElement);
    
    if (!discountModalElement) {
        console.error('[Frontend] No se encontró el elemento del modal de descuento');
        Swal.fire({
            icon: 'error',
            title: 'Error',
    ...
    console.log('[Frontend] Cargando información de descuento...');
    loadDiscountInfo();
    ...
    // Mostrar el modal
    console.log('[Frontend] Mostrando modal...');
    console.log('[Frontend] Bootstrap disponible:', typeof bootstrap !== 'undefined');
    
    if (typeof bootstrap === 'undefined') {
        console.error('[Frontend] Bootstrap no está disponible');
        Swal.fire({
            icon: 'error',
            title: 'Error',
    ...
    try {
        ...
        discountModal.show();
        console.log('[Frontend] Modal mostrado exitosamente');
    } catch (error) {
        console.error('[Frontend] Error al mostrar modal:', error);
        Swal.fire({
            icon: 'error',
            title: 'Error',
    ...
    console.log('[Frontend] showDiscountModal completado');
}
...
function calculateTotalWithDiscount() {
    ...
    console.log('[Frontend] calculateTotalWithDiscount:', {
...
function initializeDiscount() {
    ...
    console.log('[Frontend] Descuento inicializado:', currentDiscount);
}

// ✅ NUEVA: Función de prueba para verificar disponibilidad
function testDiscountFunction() {
    console.log('[Frontend] testDiscountFunction ejecutada');
    console.log('[Frontend] showDiscountModal disponible:', typeof showDiscountModal === 'function');
    console.log('[Frontend] currentDiscount:', currentDiscount);
    console.log('[Frontend] Bootstrap disponible:', typeof bootstrap !== 'undefined');
    
    // Verificar si el modal existe
    const modalElement = document.getElementById('discountModal');
    console.log('[Frontend] Modal element:', modalElement);
