...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
 => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=RestBar;Username=postgres;Password=Panama2020$");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.HasPostgresEnum<AccountType>("account_type_enum");
        modelBuilder.HasPostgresEnum<AccountCategory>("account_category_enum");
        modelBuilder.HasPostgresEnum<AccountNature>("account_nature_enum");
        ...
        // ✅ NUEVO: Configuración de Supplier
