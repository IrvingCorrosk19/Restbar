...
namespace RestBar.Controllers
{
    ...
    public class ReportsController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> SalesReport(DateTime? startDate, DateTime? endDate, string? period, Guid? branchId, Guid? userId, Guid? categoryId)
        {
            try
            {
                _logger.LogInformation("[ReportsController] Generando reporte de ventas");
        ...
        [HttpGet]
        public async Task<IActionResult> GetTopProducts(DateTime? startDate, DateTime? endDate, Guid? branchId, int? topCount)
        {
            try
            {
                var filters = new ReportFilters
        ...
        [HttpGet]
        public async Task<IActionResult> ExportPdf(DateTime? startDate, DateTime? endDate, string? period, Guid? branchId)
        {
            try
            {
                var filters = new ReportFilters
        ...
        [HttpGet]
        public async Task<IActionResult> ExportExcel(DateTime? startDate, DateTime? endDate, string? period, Guid? branchId)
        {
            try
            {
                var filters = new ReportFilters
