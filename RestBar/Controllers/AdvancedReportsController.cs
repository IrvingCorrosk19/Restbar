...
namespace RestBar.Controllers
{
    ...
    public class AdvancedReportsController : Controller
    {
        ...
        public async Task<IActionResult> SupplierAnalysis(DateTime? startDate, DateTime? endDate)
        {
            try
            {
                var filters = new ReportFilters
        ...
        [HttpGet]
        public async Task<IActionResult> GetSupplierAnalysis(DateTime? startDate, DateTime? endDate)
        {
            try
            {
                var filters = new ReportFilters
            ...
            catch (Exception ex)
            {
                ...
                return Json(new { success = false, message = "Error obteniendo análisis de proveedores" });
            }
        }

        [HttpGet]
        public async Task<IActionResult> GetSupplierPerformance(DateTime? startDate, DateTime? endDate)
        {
            try
            {
                var filters = new ReportFilters
                ...
                var performanceData = await _advancedReportsService.GetSupplierPerformanceAsync(filters);
                return Json(new { success = true, data = performanceData });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "[AdvancedReportsController] Error obteniendo rendimiento de proveedores");
                return Json(new { success = false, message = "Error obteniendo rendimiento" });
            }
        }

        [HttpGet]
        public async Task<IActionResult> GetPurchaseOrderAnalysis(DateTime? startDate, DateTime? endDate)
        {
            try
            {
                var filters = new ReportFilters
                ...
                var analysis = await _advancedReportsService.GetPurchaseOrderAnalysisAsync(filters);
                return Json(new { success = true, data = analysis });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "[AdvancedReportsController] Error obteniendo análisis de órdenes de compra");
