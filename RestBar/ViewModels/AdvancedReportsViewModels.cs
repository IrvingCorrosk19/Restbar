...
namespace RestBar.ViewModels
{
    ...
    public class SupplierAnalysisReport
    {
        ...
        public List<SupplierPerformanceData> PerformanceData { get; set; } = new();
        public List<PurchaseOrderAnalysis> PurchaseOrderAnalysis { get; set; } = new();
    }

    public class SupplierPerformanceData
    {
