...
builder.Services.AddScoped<IPaymentService>(provider =>
{
    var context = provider.GetRequiredService<RestBarContext>();
    var httpContextAccessor = provider.GetRequiredService<IHttpContextAccessor>();
    var accountingService = provider.GetRequiredService<IAccountingService>();
    return new PaymentService(context, httpContextAccessor, accountingService);
});
...
// ✅ NUEVO: Agregar servicio de proveedores
builder.Services.AddScoped<ISupplierService, SupplierService>();

// ✅ NUEVO: Agregar servicio de órdenes de compra
